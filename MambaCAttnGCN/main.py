...
with open(rf"../spy/rn_ij_list_6.pickle", "rb") as f:
...
for i in range(5):
    ...
    model = MambaCAttnGCN(deep_lnc_loc, gcn, p_encoder, d_encoder, predictor).to(device)
    fit(
        i,
        model,
        adj,
...
logger.save("MambaCAttnGCN_comb_6")
